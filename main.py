...
def main_parser():
    ...
    response_normalizer = ResponseNormalizer(anilist_fetcher, jikan_fetcher)
    file_handler = DataIO()
    
    fetch_cli = FetchCLI(response_normalizer)
    export_cli = ExportCLI(response_normalizer, file_handler)
